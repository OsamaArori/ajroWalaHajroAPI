...
$sql = "insert into history (usertype,userid , info ,phone ,address , pic ,donatestate,date,kind)
	           VALUES('$Type','$Id' ,'$Info','$Phone','$Address','$Pic','$DonateState','$Date','$Kind')";
